...
class GantryFeatureLogin extends GantryFeature
{
	...
	function _renderRokBoxLink(){
		...
		if ($isRokBox2){
			$output[] = '<a data-rokbox data-rokbox-element="#rt-popuplogin" href="#" class="readon buttontext">';
		} else {
			$output[] = '<a href="#" class="readon buttontext" rel="rokbox[385 200][module=rt-popuplogin]">';
		}
