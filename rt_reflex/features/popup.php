...
class GantryFeaturePopup extends GantryFeature
{
	...
	function _renderRokBoxLink(){
		...
		if ($isRokBox2){
			$output[] = '<a class="readon buttontext" data-rokbox href="#" data-rokbox-element="#rt-popup">';
		} else {
			$output[] = '<a href="#" class="readon buttontext" rel="rokbox['.$this->get('width').' '.$this->get('height').'][module=rt-popup]">';
		}
