 ...
 *
 * Rockettheme Camber Template uses the Joomla Framework (http://www.joomla.org), a GNU/GPLv2 content management system
 *
 */
// no direct access
					  ...
					  <div class="rt-grid-12 rt-alpha">
					  	<div class="rt-logo-block">
					      	<div class="rt-logo-surround">
    	    					<a href="<?php echo $gantry->baseUrl; ?>" id="rt-logo"><span class="logo-inner"></span><span class="fold"></span></a>
    	    				</div>
					    </div>
					  </div>
					  <div class="clear"></div>
